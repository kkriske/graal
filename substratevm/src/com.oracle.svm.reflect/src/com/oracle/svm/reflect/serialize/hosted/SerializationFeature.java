...
final class SerializationDenyRegistry implements RuntimeSerializationSupport {
    ...
    public void register(String className, String customTargetConstructorClassName) {
        register(typeResolver.resolveType(className), null);
    }
...
final class SerializationBuilder implements RuntimeSerializationSupport {
    ...
    @Override
    public void register(String targetClassName, String customTargetConstructorClassName) {
        abortIfSealed();
        ...
        if (customTargetConstructorClassName != null) {
            ...
            register(serializationTargetClass, customTargetConstructorClass);
        } else {
            register(serializationTargetClass, null);
        }
    }

    @Override
    public void register(Class<?> serializationTargetClass, Class<?> customTargetConstructorClass) {
        abortIfSealed();
